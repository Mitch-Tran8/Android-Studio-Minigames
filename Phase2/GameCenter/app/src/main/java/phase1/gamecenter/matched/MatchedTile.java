...
/**
 * A MatchedTile in a matched game board.
 */
public class MatchedTile implements Tile {
    ...
    /**
     * A MatchedTile with id and background. The background may not have a corresponding colour.
     *
     * @param id         the id
